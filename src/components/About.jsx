    ...
    <section className=" bg-back">
      ...
      "
        ...
        <div className="w-full text-left ">
          ...
          <p className="mt-3"> Я специализируюсь на уличной студийной и уличной фотографии. Через свой объектив я ловлю прекрасные образы и искренние эмоции, которые хочется сохранить навсегда.</p>
